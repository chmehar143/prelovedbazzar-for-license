								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <a type="button" class="btn btn-primary" href="{{url('admin/customer_deposit')}}"> Manage Deposit</a>
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
									...
									<tbody class="fw-bold text-gray-600">
										...
										<tr>
											...
											<td>121541500515	</td>
                                             <td><span class="badge badge-light-success">UnBlocked</span></td>
											...
											<td class="text-end">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
													...
													<div class="menu-item px-3">
														<a href="{{url('admin/customer_viewdetails')}}"
													...
													<div class="menu-item px-3">
														<a href="{{url('admin/customer_edit')}}"
