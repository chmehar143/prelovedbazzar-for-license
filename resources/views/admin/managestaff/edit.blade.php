   ...
   <div id="kt_content_container" class="container-xl" >
      ...
      <div class="card mb-5 mb-xl-10">
         ...
         <div id="kt_account_settings_profile_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" action="{{ route('admin.managestaff_update', $staff->id) }}" class="form" method="post" enctype="multipart/form-data">
               @csrf
               @method('PUT')
               <!--begin::Card body-->
                  ...
                  <div class="row mb-6">
                     ...
                     <div class="col-lg-8 fv-row">
                        <select name="role" aria-label="Select a Role" data-control="select2" data-placeholder="Select a Role..." class="form-select form-select-solid form-select-lg fw-bold">
                           <option data-kt-flag="flags/afghanistan.svg" value="{{$staff->role}}">{{$roles[$staff->role]}}</option>
                           <option data-kt-flag="flags/afghanistan.svg" value="0">Super Admin</option>
