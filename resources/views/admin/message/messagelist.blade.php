...
<div class="toolbar py-2" id="kt_toolbar">
   ...
   <div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
      <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
         <!--begin::Title-->
         <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3" style="margin-left:3pc">  Message   </h1>
         <!--end::Title-->
         <!--begin::Separator-->
         ...
         <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-dark">Message List </li>
            <!--end::Item-->
         </ul>
         <!--end::Breadcrumb-->
      </div>
...
<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="margin-top:11pc">
   <!--begin::Container-->
         ...
         <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
               ...
               <div class="d-flex align-items-center position-relative my-1">
                  ...
                  <!--end::Svg Icon-->
                  <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Message" />
               </div>
               <!--end::Search-->
            </div>
            <!--begin::Card title-->
                     ...
                     <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                           ...
                           <div class="menu-item px-3">
                              <a href="{{url('admin/message_messagelist_view')}}" class="menu-link px-3">View</a>
                           </div>
                           <!--end::Menu item-->
                           <!--begin::Menu item-->
                           <div class="menu-item px-3">
         ...
         <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
               ...
               <div class="modal-header">
                  <!--begin::Modal title-->
                  <h2 class="fw-bolder">Add Dispute</h2>
                  <!--end::Modal title-->
                  <!--begin::Close-->
               ...
               <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                  <!--begin::Form-->
                  <form id="kt_customers_export_form" class="form" action="{{ route('admin.message_send') }}" method="post">
					@csrf
                     <!--begin::Input group-->
                     ...
                     <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" placeholder="Order Number" name="order" />
                        <!--end::Input-->
                     </div>
                     <div class="fv-row mb-10">
                        <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" placeholder="Subject" name="subject" />
                        <!--end::Input-->
                     </div>
                     <div class="fv-row mb-10">
                        <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea name="text" class="form-control form-control-lg form-control-solid" placeholder="Your Message " rows="6"></textarea>
                        <!--end::Input-->
                     </div>
                     <!--begin::Row-->
                     <!--end::Row-->
                     ...
                     <span id="kt_customers_export_submit"></span>
                     <!--end::Actions-->
                  </form>
                  <!--end::Form-->
               </div>
