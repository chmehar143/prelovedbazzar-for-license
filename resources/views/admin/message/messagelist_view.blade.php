...
<div class="mr-breadcrumb">
    <div class="row">
        ...
        <div class="col-lg-12" style="margin-left:5pc">
        <br><br><Br><br>
                            ...
                            <div class="panel-body" id="messages">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <img class="img-circle" src="https://royalscripts.com/demo/kingcommerce/assets/images/noimage.png" alt="">

    <br><Br>
                                    <a  class="d-block profile-btn" href="{{url('admin/message_view')}}">View Profile</a>
    <br><Br>
                                ...
                                <div class="single-reply-area admin">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="reply-area">
                                                <div class="left">
                                                    <img class="img-circle" src="https://royalscripts.com/demo/kingcommerce/assets/images/admins/1556780563user.png" alt="">
                                                    <p class="ticket-date">1 year ago</p>
                                                </div>
                                                <div class="right">
                                                    <p>Thank you</p>
