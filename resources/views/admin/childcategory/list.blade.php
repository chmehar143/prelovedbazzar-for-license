      ...
      <div class="card container">
         <div class="card-header border-0 pt-6">
            ...
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
               ...
               <!--begin::Add products-->
               <a type="button" class="btn btn-primary" href="{{ route('admin.child_category_create')}}">Add Child Category</a>
               <!--end::Add products-->
            </div>
            <!--end::Toolbar-->
            <!--begin::Group actions-->
                  ...
                  <thead>
                     ...
                     <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
						...
						<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1"
							aria-label=" Category : activate to sort column ascending" style="width: 192.25px;"> Category </th>
                        <th class="min-w-100px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1"
							aria-label=" Subcategory : activate to sort column ascending" style="width: 192.25px;"> Subcategory </th>
                        <th class="min-w-100px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1"
