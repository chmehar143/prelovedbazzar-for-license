   ...
   <div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
      ...
      <div class="d-flex align-items-center flex-wrap">
         ...
         <div class="d-flex align-items-center">
            ...
            <span class="fw-bolder" id="kt_dashboard_daterangepicker_date">Sep 30</span>
            </a>
            <!--end::Daterangepicker-->
            <!--begin::Actions-->
            <div class="d-flex align-items-center">
         ...
         <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
               ...
               <div class="d-flex align-items-center position-relative my-1">
                  ...
                  <!--end::Svg Icon-->
                  <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Subscription Plan">
               </div>
               <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
               ...
               <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                  ...
                  <!--begin::Menu 1-->
                  <!--begin::Add customer-->
                  <a type="button" class="btn btn-primary" href="{{url('admin/subscriptionplan_create')}}">Add Subscription Plan</a>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
               ...
               <thead>
                  ...
                  <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                     ...
                     <th class="min-w-125px">Currency Symbol	</th>
                     <th class="min-w-125px"> Cost </th>
                     <th class="min-w-125px">Duration </th>
                     <th class="min-w-125px"> Product Allowed	 </th>
                     <th class="min-w-125px d-none">Status </th>
                  </tr>
                  <!--end::Table row-->
               </thead>
               <!--end::Table head-->
                     ...
                     <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                           ...
                           <div class="menu-item px-3">
                              <a href="{{ route('admin.subscriptionplan_view',$plan->id )}}" class="menu-link px-3">View</a>
                           </div>
                           <!--end::Menu item-->
                           <div class="menu-item px-3">
                              <a href="{{ route('admin.subscriptionplan_edit',$plan->id )}}" class="menu-link px-3">Edit</a>
                           </div>
                           <div class="menu-item px-3">
                              <a href="javascript:void(0)" class="menu-link px-3" data-kt-customer-table-filter="delete_row" 
							  		onclick="destroy({{$plan->id}})">Delete</a>
                           </div>
                           <!--begin::Menu item-->
                           <!--end::Menu item-->
                        </div>
...
function destroy(id) {
	Swal.fire({
		...
		if (result.isConfirmed) {
			var url = "{{ route('admin.subscriptionplan_remove', ':id') }}";
