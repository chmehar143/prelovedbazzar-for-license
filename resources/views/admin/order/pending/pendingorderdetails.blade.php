	...
	<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
		<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
			...
			<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
				...
				<!--end::Item-->
				<!--begin::Item-->
				<li class="breadcrumb-item text-dark"> Pending Orders Details List</li>
				<!--end::Item-->
			</ul>
			<!--end::Breadcrumb-->
		</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="special-box">
						...
						<div class="footer-area"> <a href="{{url('admin/order_pending_pendingorderinvoice')}}" class="mybtn1"><i class="fas fa-eye"></i> View Invoice</a> </div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="special-box">
										...
										<table id="example2" class="table table-hover dt-responsive dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid">
											...
											<tbody>
												<tr role="row" class="odd">
													<td tabindex="0">
														<input type="hidden" value="101S000000">101</td>
													<td> <a target="_blank" href="https://royalscripts.com/demo/kingcommerce/admin/vendors/13/show">Test Stores</a> </td>
													<td> <span class="badge badge-warning">Pending</span> </td>
													<td>
														<input type="hidden" value=""> <a target="_blank" href="https://royalscripts.com/demo/kingcommerce/item/physical-product-title-title-will-be-here-101-8e1101lbq">Physical Product Title Title w...</a> </td>
													<td>
														<p> <strong>Size :</strong> S </p>
														<p> <strong>color :</strong> <span style="width: 40px; height: 20px; display: block; background: #000000;"></span> </p>
														<p> <strong>Price :</strong> ₹8963.5 </p>
