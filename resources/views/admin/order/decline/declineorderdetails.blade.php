                                ...
                                <div class="col-lg-6">
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%">:</th>
                                                    <td width="45%"><span class="badge badge-danger">cancel</span></td>
                                        ...
                                        <div class="footer-area">
                                            <a href="{{url('admin/order_decline_declineorderinvoice')}}" class="mybtn1"><i class="fas fa-eye"></i> View Invoice</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
