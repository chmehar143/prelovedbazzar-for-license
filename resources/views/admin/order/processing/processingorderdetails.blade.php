                                ...
                                <div class="col-lg-6">
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%">:</th>
                                                    <td width="45%"><span class="badge badge-warning">proceesing</span></td>
                                        ...
                                        <div class="footer-area">
                                            <a href="{{url('admin/order_processing_processingorderinvoice')}}" class="mybtn1"><i class="fas fa-eye"></i> View Invoice</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12 order-details-table">
                                        <div class="mr-table">
                                            ...
                                            <div class="table-responsiv">
                                                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row btn-area"><div class="col-sm-4"></div><div class="col-sm-4"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-hover dt-responsive dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid">
                                                        <thead>
                                                            <tr role="row">
                                </tr><tr role="row"><th width="10%" class="sorting_disabled" rowspan="1" colspan="1">Product ID#</th><th class="sorting_disabled" rowspan="1" colspan="1">Shop Name</th><th class="sorting_disabled" rowspan="1" colspan="1">Vendor Status</th><th class="sorting_disabled" rowspan="1" colspan="1">Product Title</th><th width="20%" class="sorting_disabled" rowspan="1" colspan="1">Details</th><th width="10%" class="sorting_disabled" rowspan="1" colspan="1">Total Price</th></tr>
                                            ...
                                            <td>
                                                                                                                                                                    ...
                                                                                                                                                                    <span class="badge badge-warnning">proceesing</span>
                                            ...
                                            <td>₹8963.5</td>
                                                    ...
                                                    </table></div></div><div class="row"><div class="col-sm-12 col-md-5"></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="example2_previous"><a href="#" aria-controls="example2" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="example2" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="example2_next"><a href="#" aria-controls="example2" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li></ul></div></div></div></div>
                                            </div>
                                        </div>
                                    </div>
