               ...
               <div class="card-body border-top p-9">
                     ...
                     <div class="col-lg-8">
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-12 fv-row">
                              <input type="text" name="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" value="{{$vendor->email}}" required/>
                           </div>
                           <!--end::Col-->
                           <!--begin::Col-->
                           <!--end::Col-->
                  ...
                  <div class="row mb-6">
                     ...
                     <div class="col-lg-8 fv-row">
                        <input type="text" name="shop" class="form-control form-control-lg form-control-solid"  value="{{$vendor->shop_name}}" required  />
                     </div>
                     <!--end::Col-->
                  </div>
                  <div class="row mb-6">
                  ...
                  <div class="row mb-6">
                     ...
                     <!--begin::Col-->
                     <div class="col-lg-8 fv-row">
                        <input type="text" name="name" class="form-control form-control-lg form-control-solid"  value="{{$vendor->name}}" required  />
                     </div>
                     <!--end::Col-->
                  </div>
                  <!--begin::Input group-->
                  ...
                  <div class="row mb-6">
                     ...
                     <!--begin::Col-->
                     <div class="col-lg-8 fv-row">
                        <input type="text" name="reg_no" class="form-control form-control-lg form-control-solid"  value="{{$vendor->registration}}" required  />
                     </div>
                     <!--end::Col-->
                  </div>
                  <!--begin::Input group-->
