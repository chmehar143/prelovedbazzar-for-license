...
<div class="toolbar py-2" id="kt_toolbar">
   ...
   <div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
      <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
         <!--begin::Title-->
         <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3" style="margin-left:3pc"> Sub Category  </h1>
         <!--end::Title-->
         <!--begin::Separator-->
   ...
   <div id="kt_content_container" class="container-xl" style="margin-top: 11pc;">
         ...
         <div class="card-header border-0 pt-6">
            ...
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
               ...
               <!--begin::Add products-->
               <a type="button" class="btn btn-primary" href="{{route('admin.sub_category_create')}}">Add Sub Category</a>
               <!--end::Add products-->
            </div>
            <!--end::Toolbar-->
            <!--begin::Group actions-->
            ...
            <div class="table-responsive">
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" style="width: 1046px;">
                  ...
                  <thead>
                     ...
                     <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
						...
						<th class="min-w-200px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1"
							aria-label=" Name : activate to sort column ascending" style="width: 192.25px;">Main Category</th>
                  <th class="min-w-200px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1"
						...
						<th class="min-w-300px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1"
							aria-label=" Slug : activate to sort column ascending" style="width: 192.25px;"> Slug </th>
                  ...
                  <tbody class="fw-bold text-gray-600">
				  	@forelse ($subCategories as $key => $cat)
                     <tr class="odd" id="nft_row_{{$cat->id}}">
                        <!--begin::Checkbox-->
                        <td>
