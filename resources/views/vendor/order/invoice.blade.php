               ...
               <div class="mw-lg-950px mx-auto w-100">
                  ...
                  <div class="border-bottom pb-12">
                     ...
                     <div class="d-flex justify-content-between flex-column flex-md-row">
                        <!--begin::Content-->
                        <div class="flex-grow-1 pt-7 mb-5">
                           <!--begin::Table-->
                           <div class="table-responsive border-bottom mb-7">
                              <table class="table">
                                 <thead>
                                    <tr class="border-bottom fs-6 fw-bold text-muted text-uppercase">
                                       <th class="min-w-175px pb-9">Title</th>
                                 ...
                                 <tbody>
                                    <tr class="fw-bold text-gray-700 fs-5 text-end">
                                       ...
                                       <td class="pt-11">{{$detail->pro_qnty}}</td>
                                       <td class="pt-11">pkr {{$detail->price}}</td>
                                       <td class="pt-11 fs-5 pe-lg-6 text-dark fw-bolder">pkr {{$detail->subtotal}}</td>
                                    </tr>
                                 </tbody>
                              </table>
                           </div>
                        ...
                        <!--end::Separator-->
                        <!--begin::Content-->
                        <div class="flex-grow-1 pt-7">
                           <!--begin::Total Amount-->
                           <div class="fs-xl-2x fs-2 fw-bolder float-end">$20,600.00</div>
                           <div class="fs-3 fw-bold text-muted mb-3">TOTAL AMOUNT</div>
                           <div class="text-muted fw-semibold">Taxes included</div>
                           <!--end::Total Amount-->
                           <div class="border-bottom w-100 my-3 my-lg-7"></div>
                           <!--begin::Invoice To-->
                           ...
                           <!--end::Invoice To-->
                           <!--begin::Invoice No-->
                           <h5 class="float-end">56758</h5>
                           <div class="text-gray-600 fs-6 fw-semibold mb-3">INVOICE NO.</div>
                           <!--end::Invoice No-->
                           <!--begin::Invoice Date-->
                           <div class="fs-6 text-gray-800 fw-semibold float-end">12 May, 2020</div>
                  ...
                  <!--end::Body-->
                  <!-- begin::Footer-->
                  <div class="d-flex flex-stack flex-wrap mt-lg-7 pt-3">
                     <!-- begin::Actions-->
                     <div class="my-1 me-5">
                        <!-- begin::Pint-->
