               ...
               <div class="card-body border-top p-9">
                     ...
                     <div class="col-lg-8">
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-12 fv-row">
                              <input type="text" name="title" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="user name"  />
                           </div>
                           <!--end::Col-->
                           <!--begin::Col-->
                           <!--end::Col-->
                  ...
                  <div class="row mb-6">
                     ...
                     <div class="col-lg-8 fv-row">
                        <input type="text" name="Card Holder" class="form-control form-control-lg form-control-solid" placeholder="Card Holder Name   " />
                     </div>
                     <!--end::Col-->
                  </div>
                  <div class="row mb-6">
                     ...
                     <!--begin::Col-->
                     <div class="col-lg-8 fv-row">
                        <input type="text" name="Card no" class="form-control form-control-lg form-control-solid" placeholder="Card No"  />
                     </div>
                     <!--end::Col-->
                  </div>
                  <div class="row mb-6">
                     ...
                     <!--begin::Col-->
                     <div class="col-lg-8 fv-row">
                        <input type="text" name="Month" class="form-control form-control-lg form-control-solid" placeholder="Month "  />
                     </div>
                     <!--end::Col-->
                  </div>
                  <div class="row mb-6">
                     ...
                     <!--begin::Col-->
                     <div class="col-lg-8 fv-row">
                        <input type="text" name="Year" class="form-control form-control-lg form-control-solid" placeholder="Year" />
                     </div>
                     <!--end::Col-->
                  </div>
                  ...
                  <div class="row mb-6">
                     ...
                     <!--begin::Col-->
                     <div class="col-lg-8 fv-row">
                        <input type="text" name="CVV" class="form-control form-control-lg form-control-solid" placeholder="CVV" />
                     </div>
                     <!--end::Col-->
                  </div>
