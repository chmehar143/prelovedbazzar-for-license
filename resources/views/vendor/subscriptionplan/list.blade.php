											...
											<div class="col-xl-4">
												<div class="d-flex h-100 align-items-center">
													...
													<div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">
														...
														<a href="{{url('vendor/subscriptionplan_create')}}" class="btn btn-sm btn-primary">Select</a>
														<br>
														&nbsp;
														&nbsp;
														<a href="{{url('vendor/subscriptionplan_view')}}" class="btn btn-sm btn-primary">View</a>
														</div>														<!--end::Select-->
																											</div>
													<!--end::Option-->
												</div>
