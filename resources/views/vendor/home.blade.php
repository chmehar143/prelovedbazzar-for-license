         ...
         <div class="col-xl-4">
            ...
            <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
               ...
               <div class="card-body">
                  ...
                  <!--end::Svg Icon-->
                  <div class="text-white fw-bolder fs-2 mb-2 mt-5">Today's Sale</div>
                  <div class="fw-bold text-white">${{ number_format((float)$today_sale, 2, '.', '') }}</div>
               </div>
               <!--end::Body-->
            </a>
         ...
         <div class="col-xl-4">
            ...
            <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
               ...
               <div class="card-body">
                  ...
                  <!--end::Svg Icon-->
                  <div class="text-white fw-bolder fs-2 mb-2 mt-5">Today's Order</div>
                  <div class="fw-bold text-white">{{ $today_order }}</div>
               </div>
               <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
         ...
         <div class="col-xl-4">
            ...
            <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
               ...
               <div class="card-body">
                  ...
                  <!--end::Svg Icon-->
                  <div class="text-white fw-bolder fs-2 mb-2 mt-5">Today's Confirmed Order</div>
                  <div class="fw-bold text-white">{{ $today_confirm }}</div>
               </div>
               <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
         ...
         <div class="col-xl-4">
            ...
            <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
               ...
               <div class="card-body">
                  ...
                  <!--end::Svg Icon-->
                  <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total balance</div>
                  <div class="fw-bold text-white">${{ number_format((float)$today_sale, 2, '.', '') }}</div>
               </div>
               <!--end::Body-->
            </a>
         ...
         <div class="col-xl-4">
            ...
            <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
               ...
               <div class="card-body">
                  ...
                  <!--end::Svg Icon-->
                  <div class="text-white fw-bolder fs-2 mb-2 mt-5">Available for withdraw</div>
                  <div class="fw-bold text-white">{{ $today_order }}</div>
               </div>
               <!--end::Body-->
            </a>
         ...
         <div class="col-xl-4">
            ...
            <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
               ...
               <div class="card-body">
                  ...
                  <!--end::Svg Icon-->
                  <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total received amount</div>
                  <div class="fw-bold text-white">{{ $today_confirm }}</div>
               </div>
               <!--end::Body-->
            </a>
        ...
        <script>
            const data1 = {
                ...
                datasets: [{
                    ...
                    data: [
                        <?php echo json_encode($out_of_stock) ?>,
                        <?php echo json_encode($product_sale) ?>,
                        <?php echo json_encode($total_product) ?>
                    ],
                    backgroundColor: [
                        'rgb(255, 99, 132)',
                        'rgb(54, 162, 235)',
