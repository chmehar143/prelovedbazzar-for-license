   ...
   <div id="kt_content_container" class="container-xxl" >
      ...
      <div class="card mb-5 mb-xl-10">
         ...
         <div id="kt_account_settings_profile_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" action="{{ route('vendor.product_add')}}" class="form" method="post" enctype="multipart/form-data">
               @csrf
               <!--begin::Card body-->
               <div class="card-body border-top p-9">
                  ...
                  <div class="row mb-6">
                     ...
                     <div class="col-lg-2 fv-row">
                        <input type="color" name="p_color" class="form-control form-control-lg form-control-solid @error('p_color') is-invalid @enderror"  />
                        @error('p_color')
                        <div class="validation mt-1 text-danger">{{ $message }}</div>
                        @enderror
                     </div>
