...
<div class="toolbar py-2" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center"><div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark"> View Service </li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
...
<div id="kt_content_container" class="container-xxl" style="margin-top:11pc;margin-left:7pc">
							<!--begin::Navbar-->
                                      ...
                                      <div class="d-flex flex-wrap py-5">
                                        ...
                                        <div class="flex-equal me-5">
                                          <table class="table table-flush fw-bold gy-1">
                                            <tbody>
                                            <tr>
                                              <td class="text-muted min-w-125px w-125px">Feautured Image</td>
                                              <td class="text-gray-800"><img src="#"></td>
                                            </tr>
                                            <tr>
                                              <td class="text-muted min-w-125px w-125px">Title </td>
                                              <td class="text-gray-800">Lorem</td>
                                            </tr>
                                        ...
                                        <div class="flex-equal">
                                          <table class="table table-flush fw-bold gy-1">
                                            ...
                                            <tr>
                                              ...
                                              <td class="text-gray-800">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores quisquam, voluptates doloremque, voluptatibus quod ad, sapiente vitae ipsam nam autem delectus architecto culpa accusantium magni. Nihil odio est consequatur ex!</td>
                                            </tr>
