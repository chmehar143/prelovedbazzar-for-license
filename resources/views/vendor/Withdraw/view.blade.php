...
<div class="toolbar py-2" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center"><div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark"> View Withdraw list </li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
                                      ...
                                      <div class="d-flex flex-wrap py-5">
                                        ...
                                        <div class="flex-equal me-5">
                                          <table class="table table-flush fw-bold gy-1">
                                            <tbody>
                                            <tr>
                                              <td class="text-muted min-w-125px w-125px">Withdraw Date</td>
                                              <td class="text-gray-800">20-09-2022</td>
                                            </tr>
                                            <tr>
                                              <td class="text-muted min-w-125px w-125px">Payment Method</td>
                                              <td class="text-gray-800">Paypal</td>
                                            </tr>

                                          
                                            
                                            <tr>
                                              <td class="text-muted min-w-125px w-125px">Account</td>
