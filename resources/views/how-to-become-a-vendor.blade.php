                            ...
                            <div class="col-lg-8">
                                <div class="swiper">
                                    <div class="swiper-container swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events" data-swiper-options="{
                                        ...
                                        <div class="swiper-wrapper " id="swiper-wrapper-86585106a3dea5c4d" aria-live="polite" style="transform: translate3d(-840px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide testimonial-wrap swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="1 / 7" style="width: 400px; margin-right: 20px;">
                                            ...
                                            </div><div class="swiper-slide testimonial-wrap swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="2" role="group" aria-label="2 / 7" style="width: 400px; margin-right: 20px;">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class=" testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                            ...
                                            <div class="swiper-slide testimonial-wrap swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="3 / 7" style="width: 400px; margin-right: 20px;">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class="testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                            ...
                                            <div class="swiper-slide testimonial-wrap swiper-slide-next" data-swiper-slide-index="1" role="group" aria-label="4 / 7" style="width: 400px; margin-right: 20px;">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class="testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="assets/images/agents/2-100x100.png" alt="Testimonial" width="100" height="100">
                                            ...
                                            <div class="swiper-slide testimonial-wrap swiper-slide-duplicate-prev" data-swiper-slide-index="2" role="group" aria-label="5 / 7" style="width: 400px; margin-right: 20px;">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class=" testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="assets/images/agents/3-100x100.png" alt="Testimonial" width="100" height="100">
                                        ...
                                        <div class="swiper-slide testimonial-wrap swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="6 / 7" style="width: 400px; margin-right: 20px;">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class="testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="assets/images/agents/1-100x100.png" alt="Testimonial" width="100" height="100">
                                            ...
                                            </div><div class="swiper-slide testimonial-wrap swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="7 / 7" style="width: 400px; margin-right: 20px;">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class="testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="assets/images/agents/2-100x100.png" alt="Testimonial" width="100" height="100">
                                        ...
                                        <div class="swiper-pagination swiper-pagination-clickable swiper-pagination-bullets" style="display: block;"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span></div>
