                        ...
                        <div class="product-qty-form with-label">
                           ...
                           <div class="input-group">
                              <input class="quantity form-control" type="number" min="1"
                                 max="10000000">
                              <a href="#" class="quantity-plus w-icon-plus" style="margin-left: -4pc;margin-top:10px; width: 2.4rem;height: 2.4rem;
                                 border-radius: 50%;
                                 ...
                                 font-size: 1.4rem;
                                 border: none;"></a>
                              <a href="#" class="quantity-minus w-icon-minus" style="position: absolute;
                                 top: 50%;
