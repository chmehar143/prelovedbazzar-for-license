                        ...
                        <div class="compare-row cols-xl-5 cols-lg-4 cols-md-3 cols-2 compare-products">
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{asset('frontend-assets/assets/images/products/elements/1.jpg')}}" alt="Product" width="228"
                                                height="257" />
                                        </a>
                            ...
                            <div class="compare-col compare-product">
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{asset('frontend-assets/assets/images/products/elements/2.jpg')}}" alt="Product" width="228"
                                                height="257" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"></a>
                            ...
                            <div class="compare-col compare-product">
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{asset('frontend-assets/assets/images/products/elements/3.jpg')}}" alt="Product" width="228"
                                                height="257" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"></a>
                            ...
                            <div class="compare-col compare-product">
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{asset('frontend-assets/assets/images/products/elements/4-1.jpg')}}" alt="Product" width="228"
                                                height="257" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"></a>
