    ...
    <main class="main">
            ...
            <div class="page-content become-a-vendor">
                <div class="container create-store pb-1 pb-lg-10 mb-10">
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-4 mb-md-0">
                            <figure class="br-sm">
                                <img src="{{asset('frontend-assets/assets/images/pages/become/1.jpg')}}" alt="Banner"
                    ...
                    <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <figure class="br-sm">
                                    <img src="{{asset('frontend-assets/assets/images/pages/become/2.jpg')}}" alt="Banner"
                                        ...
                                        <div class="swiper-wrapper row cols-sm-2">
                                                ...
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class="testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="{{asset('frontend-assets/assets/images/agents/1-100x100.png')}}" alt="Testimonial" width="100"
                                                                height="100" />
                                                        </figure>
                                            ...
                                            <div class="swiper-slide testimonial-wrap">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class="testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="{{asset('frontend-assets/assets/images/agents/2-100x100.png')}}" alt="Testimonial" width="100"
                                                                height="100" />
                                                        </figure>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                            ...
                                            <div class="swiper-slide testimonial-wrap">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class=" testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="{{asset('frontend-assets/assets/images/agents/3-100x100.png')}}" alt="Testimonial" width="100"
                                                                height="100" />
                                                        </figure>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                ...
                <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}"
                    data-image-src="{{asset('frontend-assets/assets/images/pages/become/3.jpg')}}" style="background-color: #929294;">
                    <div class="container">
