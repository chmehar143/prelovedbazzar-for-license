...
class AffilateProductController extends Controller
{
    ...
    public  function  create()
    {
        ...
        return view('vendor.affilateproduct.create', compact('categories'));
    }
    ...
    public  function  edit($id)
    {
        ...
        $type = Config::get('constants.type');
        return view('vendor.affilateproduct.edit', compact('product', 'categories', 'type', 'catog','sub_cat','ch_cat'));
    }
    // update ...
