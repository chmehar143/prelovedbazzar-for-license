...
class SortBySubcat extends Component
{
    public $product, $quantitycount = 1, $p_size = 'medium', $sub_id;
    ...
    public function mount($id)
    {
        ...
        $this->sub_id = $subcategory->id;
    }

    public function render()
    {
        $products = Product::where('products.status', 1)->where('p_sub_catog', $this->sub_id)->where('products.status', 1)->with('discussions')
        ...
        return view('livewire.userend.products.sort-by-subcat',[
            'products' => $products,
